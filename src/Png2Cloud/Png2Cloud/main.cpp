...
int main(int argc, char**argv)
{
	...
	/*std::string depth_dir = "E:/Rec/rgbd_dataset_freiburg2_desk/sandbox_25/depth/";
	std::string color_dir = "E:/Rec/rgbd_dataset_freiburg2_desk/sandbox_25/color/";
	std::string camera_para = "C:/Users/range/Desktop/calibration_test/sandbox/camera_para.txt";

	std::string pointcloud_dir = "E:/Rec/rgbd_dataset_freiburg2_desk/sandbox_25/pointcloud/";
	std::string pointcloud_ds_dir = "E:/Rec/rgbd_dataset_freiburg2_desk/sandbox_25/pointcloud_ds/";

	std::string xyzn_dir = "E:/Rec/rgbd_dataset_freiburg2_desk/sandbox_25/pointcloud_xyzn/";
	std::string xyzn_ds_dir = "E:/Rec/rgbd_dataset_freiburg2_desk/sandbox_25/pointcloud_ds_xyzn/";*/
